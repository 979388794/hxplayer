...
import com.example.hxplay.bean.ResponseBean;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ResponseBean loginBean;
    ...
    private void Login() {
        ...
        try {
            object.put("account", "979388794@qq.com");
            object.put("password", "GO112233");
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                Log.i("henry", "onFailure" + e.getMessage());
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    Log.i("henry", "请求成功" + result);
                    Gson gson = new Gson();
//                    Gson gson2  = new GsonBuilder().registerTypeAdapterFactory(new NullStringEmptyTypeAdapterFactory()).create();
                    ResponseBean loginBean = gson.fromJson(result, ResponseBean.class);
                    Log.d("henry", " " + loginBean.toString());
                    String token = loginBean.getResult().getToken();
                    Log.i("henry", "token =" + token);
                    // 把登录信息 & token保存到本地
