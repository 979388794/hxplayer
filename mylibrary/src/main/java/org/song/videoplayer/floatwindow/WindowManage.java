...
public class WindowManage {
     ...
     * 添加悬浮窗
     */
    public void addWindowView(View view, LayoutParams windowParams) {
     ...
     * 更新悬浮窗
     */
    public void updateWindowView(View view, LayoutParams windowParams) {
        WindowManager windowManager = getWindowManager(view.getContext());
        if (windowManager != null)
    ...
    public LayoutParams creatParams(int type, FloatParams floatParams) {
        //系统浮窗不能超出边界,更新xy
